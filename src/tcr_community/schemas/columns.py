...
# Preditoras para clustering/multivariada (Fase 2)
CLUSTERING_CATEGORICAL_COLS: Final[list[str]] = [
    COL_COMORBIDADES,
    COL_VENTILACAO_MECANICA,
    COL_DROGAS_VASOATIVAS,
    COL_TRANSFUSAO,
...
CLUSTERING_NUMERIC_COLS: Final[list[str]] = [
    COL_APACHE_II,
    COL_TEMPO_UTI,
]

CLUSTERING_FEATURES: Final[list[str]] = [
    *CLUSTERING_CATEGORICAL_COLS,
    *CLUSTERING_NUMERIC_COLS,
]

TREE_PREDICTORS: Final[list[str]] = list(ASSOCIATION_PREDICTORS)
